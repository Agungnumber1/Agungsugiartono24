...
/////////////////
const BotName = 'bot pridavan☄'; 
const instagram = 'https://https://www.instagram.com/agungsugiartono.24jam'; 
const telegram = 'https://t.me/Agung24'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/Agung';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@Agungsugiartono.24jam')
