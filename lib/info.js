exports.info = (id, Botsuper, corohelp, tampilTanggal, tampilWaktu, instagram, telegram, youtube, kapanbotaktif, grupch1, grupch2) => {
	return `🇮🇩 ${Botsuper} 🇮🇩
...
INFO BOT! :
🔱 *AUTHOR*: Agungsugiartono
🔱 *GITHUB*: https://github.com/Agungnumber1/Agungsugiartono24
🔱 *INSTAGRAM*: ${Agungsugiartono.24jam}
🔱 *YOUTUBE*: ${rahasia}
🔱 *TELEGRAM* : ${TELEGRAM}
🔱 *WHATSAPP* : 0895635751558
